...
async function fixStudentFinal() {
  console.log('🔧 Fixing Student Data Issues for Sripathi (Final)');
  ...
  try {
    ...
    for (const interventionId of interventionsWithScores) {
      ...
      if (existingEnrollment.rows.length === 0) {
        // Create enrollment with correct enum values (using the sample as reference)
        const enrollmentResult = await query(
          supabase
            ...
            .insert({
              ...
              enrollment_status: 'Enrolled', // From sample
              enrollment_type: 'Mandatory', // From sample - using valid enum
              progress_data: {},
              current_score: 85,
    ...
    console.log('5. Test individual quadrant pages for score consistency');
